...
# ─── RULE-CDTR-001 enforcement ─────────────────────────────────────────────────
# Governance rule: Code Health Drives Technical Results
# Block validation if critical security findings are unacknowledged > 7 days
rule_path = root / "state/contracts/RULE-CDTR-001.json"
if rule_path.exists():
    try:
        import sys as _sys
        _tools = root / "tools"
