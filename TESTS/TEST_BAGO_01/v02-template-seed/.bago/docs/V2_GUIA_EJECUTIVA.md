...
BAGO V2 tiene un score de salud calculado automáticamente. En este **pack limpio distribuible**, el score refleja sobre todo la integridad del paquete y la coherencia del estado. Como el ZIP arranca sin sesiones cerradas, las dimensiones de disciplina y captura parten de valores conservadores hasta que el proyecto genere histórico propio.
...
# Salida:
BAGO Health Score: 80/100  🟢
  Integridad:          25/25 ✅
  Disciplina workflow: 10/20 ⚠️  (sin sesiones cerradas)
  Captura decisiones:  10/20 ⚠️  (sin sesiones cerradas)
  Estado stale:        15/15 ✅
  Consistencia inv.:   20/20 ✅
```
...
| `docs/V2_PROPUESTA.md` | Documento histórico con la propuesta que originó esta versión |
