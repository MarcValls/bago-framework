...
FALLBACK_IDEAS: list[dict[str, object]] = [
    ...
    },
    {
        ...
        "section": "respaldo",
        "risk": "low",
        "metric": "debt_ledger.py no tiene flag --csv para exportar deuda técnica a CSV.",
        "title": "debt_ledger --csv export",
        "summary": "Añadir --csv a debt_ledger.py para exportar ítems de deuda a CSV.",
        "detail": [
            "Añadir --csv argparse flag a debt_ledger.py.",
            "Cuando --csv, imprimir header y filas: id,title,hours,cost,quadrant.",
        ],
        "w2": "Implementar --csv en debt_ledger.py y añadir test.",
        "next_step": "Añadir --csv a debt_ledger.py y test que verifica header CSV.",
    },
    {
        "priority": 55,
        "section": "respaldo",
        "risk": "low",
        "metric": "risk_matrix.py no tiene flag --csv para exportar riesgos a CSV.",
        "title": "risk_matrix --csv export",
        "summary": "Añadir --csv a risk_matrix.py para exportar riesgos a CSV.",
        "detail": [
            "Añadir --csv argparse flag a risk_matrix.py.",
            "Cuando --csv, imprimir header y filas: id,title,probability,impact,score.",
        ],
        "w2": "Implementar --csv en risk_matrix.py y añadir test.",
        "next_step": "Añadir --csv a risk_matrix.py y test que verifica header CSV.",
    },
    {
        "priority": 53,
        "section": "respaldo",
        "risk": "low",
        "metric": "pack_dashboard.py no tiene flag --minimal para output ultra-compacto.",
        "title": "dashboard --minimal flag",
        "summary": "Añadir --minimal a pack_dashboard.py para output de 3 líneas: health, changes, tests.",
        "detail": [
            "Añadir --minimal argparse flag.",
            "Output: 3 líneas — health score, CHG count, test count.",
        ],
        "w2": "Implementar --minimal en pack_dashboard.py y añadir test.",
        "next_step": "Añadir --minimal a pack_dashboard.py main() y test que verifica ≤5 líneas.",
    },
    {
        "priority": 51,
        "section": "respaldo",
        "risk": "low",
        "metric": "velocity.py no tiene flag --since YYYY-MM-DD para filtrar por fecha de inicio.",
        "title": "velocity --since date filter",
        "summary": "Añadir --since YYYY-MM-DD a velocity.py para calcular métricas desde una fecha.",
        "detail": [
            "Añadir --since argparse flag.",
            "Filtrar sesiones por fecha >= since al calcular current period.",
        ],
        "w2": "Implementar --since en velocity.py y añadir test.",
        "next_step": "Añadir --since a velocity.py argparse y filtro de sesiones.",
    },
    {
        "priority": 49,
        "section": "respaldo",
        "risk": "low",
        "metric": "scan.py no tiene flag --format csv para exportar hallazgos a CSV.",
        "title": "scan --format csv",
        "summary": "Añadir --format csv a scan.py para exportar hallazgos en formato CSV.",
        "detail": [
            "Añadir --format csv a argparse (complementa --json).",
            "CSV header: file,line,severity,rule,message.",
        ],
        "w2": "Implementar --format csv en scan.py y añadir test.",
        "next_step": "Añadir --format csv a render_findings() y test que verifica header.",
    },
    {
        "priority": 47,
        "section": "respaldo",
        "risk": "low",
        "metric": "health_score.py no tiene flag --breakdown para detalle por check.",
        "title": "health_score --breakdown flag",
        "summary": "Añadir --breakdown a health_score.py: imprime tabla con check, score, max, detail.",
        "detail": [
            "Argparse: --breakdown action=store_true.",
            "Output: una línea por check con nombre, score/max y detalle.",
            "Test: verificar que output contiene al menos 5 líneas con '/'.",
        ],
        "w2": "Implementar --breakdown en health_score.py y añadir test.",
        "next_step": "Añadir --breakdown y test 140.",
    },
    {
        "priority": 45,
        "section": "respaldo",
        "risk": "low",
        "metric": "metrics_export.py no tiene filtro --since para acotar métricas por fecha.",
        "title": "metrics_export --since date filter",
        "summary": "Añadir --since DATE a metrics_export.py para filtrar commits/authors desde fecha.",
        "detail": [
            "Argparse: --since DATE (YYYY-MM-DD).",
            "Pasar --since a git log --after si aplica.",
            "Test: --since con fecha pasada devuelve JSON con timestamp.",
        ],
        "w2": "Implementar --since en metrics_export.py y añadir test.",
        "next_step": "Añadir --since a argparse y test 141.",
    },
    {
        "priority": 43,
        "section": "respaldo",
        "risk": "low",
        "metric": "debt_ledger.py no tiene flag --top N para limitar items mostrados.",
        "title": "debt_ledger --top N flag",
        "summary": "Añadir --top N a debt_ledger.py para mostrar solo los N items de mayor deuda.",
        "detail": [
            "Argparse: --top N type=int default=None.",
            "Aplicar truncado tras ordenar por horas desc.",
            "Test: --top 2 devuelve ≤3 líneas (header + 2 rows).",
        ],
        "w2": "Implementar --top N en debt_ledger.py y añadir test.",
        "next_step": "Añadir --top N y test 142.",
    },
    {
        "priority": 41,
        "section": "respaldo",
        "risk": "low",
        "metric": "scan.py no tiene flag --output FILE para guardar CSV/JSON en fichero.",
        "title": "scan --output file flag",
        "summary": "Añadir --output FILE a scan.py para redirigir CSV/JSON a fichero en lugar de stdout.",
        "detail": [
            "Argparse: --output FILE.",
            "Escribir a Path(args.output) en lugar de stdout si se proporciona.",
            "Test: --format csv --output /tmp/bago_scan_test.csv crea fichero con header.",
        ],
        "w2": "Implementar --output en scan.py y añadir test.",
        "next_step": "Añadir --output y test 143.",
    },
    {
        "priority": 39,
        "section": "respaldo",
        "risk": "low",
        "metric": "risk_matrix.py no tiene flag --top N para limitar riesgos mostrados.",
        "title": "risk_matrix --top N flag",
        "summary": "Añadir --top N a risk_matrix.py para mostrar solo los N riesgos de mayor exposición.",
        "detail": [
            "Argparse: --top N type=int default=None.",
            "Aplicar truncado tras sort por exposure desc.",
            "Test: --top 3 --csv devuelve ≤4 líneas (header + 3 rows).",
        ],
        "w2": "Implementar --top N en risk_matrix.py y añadir test.",
        "next_step": "Añadir --top N y test 144.",
    },
    {
        "priority": 37,
        "section": "respaldo",
        "risk": "low",
        "metric": "pack_dashboard.py --json no incluye test_count del último smoke.",
        "title": "dashboard --json test_count field",
        "summary": "Añadir test_count al output --json de pack_dashboard.py leyendo last-report.json.",
        "detail": [
            "Leer sandbox/runtime/last-report.json en el bloque as_json.",
            "Añadir campo 'test_count' con workers del último reporte.",
            "Test: --json output contiene 'test_count' como entero.",
        ],
        "w2": "Añadir test_count a pack_dashboard.py --json y test 145.",
        "next_step": "Editar bloque as_json en render() y añadir test.",
    },
    {
        "priority": 35,
        "section": "respaldo",
        "risk": "low",
        "metric": "velocity.py --json no expone rolling windows completas.",
        "title": "velocity --json rolling windows",
        "summary": "Añadir --json a velocity.py que incluye current, previous y rolling como JSON.",
        "detail": [
            "Argparse: --json action=store_true.",
            "Salida: {current:{...}, previous:{...}, rolling:[...]}.",
            "Test: --json output parseable con keys current, previous, rolling.",
        ],
        "w2": "Implementar --json en velocity.py y añadir test 146.",
        "next_step": "Añadir --json output a velocity.py y test.",
    },
    {
        "priority": 33,
        "section": "respaldo",
        "risk": "low",
        "metric": "scan.py no tiene flag --stats para mostrar resumen por severidad.",
        "title": "scan --stats flag",
        "summary": "Añadir --stats a scan.py para mostrar conteo de hallazgos por severidad en una línea.",
        "detail": [
            "Argparse: --stats action=store_true.",
            "Output: 'error=N warning=N info=N hint=N total=N'.",
            "Test: --stats output contiene 'error=' y 'total='.",
        ],
        "w2": "Implementar --stats en scan.py y añadir test 147.",
        "next_step": "Añadir --stats y test.",
    },
    {
        "priority": 31,
        "section": "respaldo",
        "risk": "low",
        "metric": "emit_ideas.py no tiene flag --section para filtrar por sección.",
        "title": "emit_ideas --section filter",
        "summary": "Añadir --section SECTION a emit_ideas.py para filtrar ideas por sección.",
        "detail": [
            "Argparse: --section str default=None.",
            "Filtrar FALLBACK_IDEAS y dynamic ideas por section == arg.",
            "Test: --section respaldo --json devuelve ideas solo de sección respaldo.",
        ],
        "w2": "Implementar --section en emit_ideas.py y añadir test 148.",
        "next_step": "Añadir --section filter y test.",
    },
    {
        "priority": 29,
        "section": "respaldo",
        "risk": "low",
        "metric": "health_score.py no soporta --watch para monitorización continua.",
        "title": "health_score --watch mode",
        "summary": "Añadir --watch N a health_score.py para refrescar score cada N segundos.",
        "detail": [
            "Argparse: --watch N type=int (segundos entre refresco).",
            "Loop: mostrar score, sleep N, limpiar pantalla, repetir. CTRL+C para salir.",
            "Test: --watch sin TTY imprime score al menos 1 vez y sale con rc=0.",
        ],
        "w2": "Implementar --watch en health_score.py y añadir test 149.",
        "next_step": "Añadir --watch y test.",
    },
    {
        "priority": 27,
        "section": "respaldo",
        "risk": "low",
        "metric": "metrics_export.py no tiene --format csv para exportación tabular.",
        "title": "metrics_export --format csv",
        "summary": "Añadir --format csv a metrics_export.py para exportar métricas como tabla CSV.",
        "detail": [
            "Argparse: --format {json,csv} default=json.",
            "CSV header: metric,value con una fila por cada métrica top-level.",
            "Test: --format csv output contiene header 'metric,value'.",
        ],
        "w2": "Implementar --format csv en metrics_export.py y añadir test 150.",
        "next_step": "Añadir --format csv y test.",
    },
    {
        "priority": 25,
        "section": "respaldo",
        "risk": "low",
        "metric": "debt_ledger.py no tiene --json para output estructurado.",
        "title": "debt_ledger --json output",
        "summary": "Añadir --json a debt_ledger.py para output JSON estructurado de deuda técnica.",
        "detail": [
            "Argparse: --json action=store_true.",
            "Salida: {total_items, cost_per_hour, items:[{file,score,cost_h}]}.",
            "Test: --json output parseable con keys total_items y cost_per_hour.",
        ],
        "w2": "Implementar --json en debt_ledger.py y añadir test 151.",
        "next_step": "Añadir --json y test.",
    },
    {
        "priority": 23,
        "section": "respaldo",
        "risk": "low",
        "metric": "velocity.py no tiene --top N para limitar sesiones en tabla CSV.",
        "title": "velocity --top N rolling",
        "summary": "Añadir --top N a velocity.py para limitar output rolling a las N ventanas más recientes.",
        "detail": [
            "Argparse: --top N type=int default=None.",
            "Aplicar al rolling list: rolling[-N:].",
            "Test: --rolling --top 3 --json devuelve rolling con ≤3 ventanas.",
        ],
        "w2": "Implementar --top N en velocity.py rolling output y añadir test 152.",
        "next_step": "Añadir --top N y test.",
    },
    {
        "priority": 21,
        "section": "respaldo",
        "risk": "low",
        "metric": "scan.py no filtra hallazgos por fecha de escaneo con --since.",
        "title": "scan --since DATE filter",
        "summary": "Añadir --since DATE a scan.py para mostrar solo hallazgos de scans desde DATE.",
        "detail": [
            "Argparse: --since DATE type=str.",
            "Filtrar FindingsDB history por scan timestamp >= since.",
            "Test: --since 2020-01-01 --stats devuelve rc=0.",
        ],
        "w2": "Implementar --since DATE en scan.py y añadir test 153.",
        "next_step": "Añadir --since DATE y test.",
    },
    {
        "priority": 19,
        "section": "respaldo",
        "risk": "low",
        "metric": "risk_matrix.py no tiene --since DATE para filtrar por scan reciente.",
        "title": "risk_matrix --since DATE",
        "summary": "Añadir --since DATE a risk_matrix.py para filtrar scans por fecha.",
        "detail": [
            "Argparse: --since DATE type=str.",
            "Filtrar scan_ids cuyo timestamp >= since_date antes de agregar.",
            "Test: --since 2020-01-01 --csv devuelve rc=0.",
        ],
        "w2": "Implementar --since DATE en risk_matrix.py y añadir test 154.",
        "next_step": "Añadir --since y test.",
    },
]
