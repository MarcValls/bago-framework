...
La 2.2.1 no abre una nueva línea. Consolida la 2.2 híbrida. El objetivo es cerrar la distancia entre la capa repo-first recuperada del enfoque flat y el núcleo canónico heredado de la línea auditada.
