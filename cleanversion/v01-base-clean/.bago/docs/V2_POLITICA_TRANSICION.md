...
## 7. Métricas históricas de referencia

Distribución histórica de workflows en BAGO (**snapshot pre-clean usado para definir estas reglas; no equivale al inventario del pack limpio actual**):
